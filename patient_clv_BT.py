...
left = np.arange(8)
ax1.bar(left, ave075, yerr=SD075, capsize=5, tick_label=label1)
ax1.axhline(y=1.0, linestyle='dashed', color='black')
ax1.set_ylim([0, 1.35])
fig1.savefig("patient_clv_BTp.png")

# %%=================================================================================
fig2 = plt.figure(figsize=(10,5))
ax2 = fig2.add_subplot(111)
ax2.bar(label1, ave05, width=-0.4, yerr=SD05, capsize=5, align='edge', label=">0.5")
ax2.bar(label1, ave075, width=0.4, yerr=SD075, capsize=5, align='edge', label=">0.75")
ax2.axhline(y=1.0, linestyle='dashed', color='black')
ax2.legend(loc="best", fontsize=10)
ax2.set_ylim([0, 1.35])
fig2.savefig("patient_clv_BT.png")
